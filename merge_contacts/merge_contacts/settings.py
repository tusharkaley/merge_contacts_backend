"""
Django settings for merge_contacts project.
...
SECRET_KEY = ')%c%!7en@j8c9yd^r_o=3%^typy@d#lqanoyonv0ixpeeb38yk'
...
WSGI_APPLICATION = 'merge_contacts.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/home/ubuntu/workspace/logs/debug.log',
        },
    },
    'loggers': {
        'django': {
